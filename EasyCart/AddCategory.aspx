<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="EasyCart.AddCategory" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Easy Cart - Add Category</title>
                ...
                <section class="content">
                    <div class="card card-primary">
                        ...
                        <div class="card-footer">
                            <asp:Button ID="btnAddCategory" runat="server" CssClass="btn btn-info" ClientIDMode="Static" Text="Add Category" OnClientClick="return validate()" OnClick="btnAddCategory_Click" />
